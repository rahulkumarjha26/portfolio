...
* Developed data ingestion and processing workflows for an AI-powered talent intelligence platform, handling thousands of unstructured candidate profiles daily.
* Integrated RESTful APIs and machine learning inference endpoints for automated candidate screening, entity extraction, and skill relevance scoring.
* Optimized complex SQL queries and relational database schemas in PostgreSQL, achieving a **35% improvement** in candidate search query latency.
* Implemented data validation, deduplication, and cleaning scripts to ensure high data integrity across relational talent pools.

---

## KEY PROJECTS

### Numera — Air-Gapped Tabular Intelligence Engine | [GitHub](https://github.com/rahulkumarjha26/numera)
*Python 3.12, DuckDB OLAP, LangGraph, Ollama (Local LLM), Next.js 16, Polars, FastAPI*
* Architected an air-gapped enterprise tabular intelligence engine allowing confidential analysis of 50,000+ row spreadsheets with zero cloud data transmission and zero context overflow.
* Implemented schema virtualization and deterministic in-memory DuckDB OLAP execution, reducing token overhead by **99.8%** and completing complex analytical aggregations in **under 20ms**.

### Threadmark — AI Insurance Command Center | [GitHub](https://github.com/rahulkumarjha26/threadmark)
*Python 3.12, FastAPI, Postgres + pgvector, Next.js 15, Hybrid RAG (RRF), Cross-Encoder, Evals*
* Architected a multi-agent system (6 specialist agents) where financial computations and eligibility are deterministic code tools and citations are verified in code before display.
* Implemented a 5-layer retrieval pipeline (dense vectors, BM25 hybrid with Reciprocal Rank Fusion, cross-encoder rerank) achieving **94.2% refusal accuracy** across an 86-case golden evaluation benchmark.

### RetailGuard AI — Loss Prevention & Theft Vision Engine | [GitHub](https://github.com/rahulkumarjha26/retail-guard-ai)
*Python, PyTorch, YOLOv11-Pose, ViViT Transformers, OpenCV, FastAPI, Edge MPS/CUDA*
* Engineered a retail theft surveillance system combining YOLOv11 human pose estimation, anatomical concealment geometry, and spatiotemporal Video Vision Transformers (ViViT).
* Developed dynamic pocket projection anchored to 17 skeletal keypoints and an occlusion-verification state machine; sustained **30.0+ FPS** real-time inference on Apple Silicon MPS/CUDA.
...
* **AI: Constraint Satisfaction** — IIT Madras
